...
class SecurityController extends BaseController
{
    ...
    {
        return $this->render('RecENTUserBundle:Security:login.html.twig', $data);
    }

    protected function renderLoginNotLoginPage(array $data) //za renderiranje samo forme, a ne cijele samo stranice
    {
